...
public abstract class AbstractClient extends Artifact {
    ...
    protected void init(final String agentName, final String mailboxUri, final String platformUri) {
    ...
    protected final String getMailboxUri() {
        return this.mailboxUri;
    }

    protected final String getPlatformUri() {
        return this.platformUri;
    }

    protected final String getAgentId() {
        return this.platformUri + "/agent/" + this.agentName;
    }
